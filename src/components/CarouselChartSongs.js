...
import { MostPlayed, SongsDiv, ButtonsDiv } from '../styles';
...
class CarouselChartSongs extends React.Component {
  constructor() {
    super();
...
export default connect(mapStateToProps, mapDispatchToProps)(CarouselChartSongs);
